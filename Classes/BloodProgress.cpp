...
void BloodProgress::setBackgroundTexture(const char *pName)
{
	m_progressBackground = CCSprite::create(pName);
	this->addChild(m_progressBackground);
}

void BloodProgress::setForegroundTexture(const char *pName)
{
...
void BloodProgress::setTotalProgress(float total)
{
...
void BloodProgress::setCurrentProgress(float progress)
{
	if (m_progressForeground == NULL) { return; }
...
float BloodProgress::getCurrentProgress() const
{
	return m_currentProgress;
}

float BloodProgress::getTotalProgress() const
{
